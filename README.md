...
### **How to Run**
1. Clone the repo.
2. Run `01_generate_diagnostic_data.py` to build the engine.
3. Run `02_load_postgres.py` to build the DB (Update credentials in script).
4. Run `streamlit run 04_dashboard_app.py` to launch the UI.